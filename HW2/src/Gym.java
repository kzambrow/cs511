...
public class Gym implements Runnable {
	...
	public void useApparatus(int id, ApparatusType at, Map<WeightPlateSize, Integer> weight, int duration) {
		...
		System.out.println(id + " is using the "+ at + " with " + 
			...
			weight.get(WeightPlateSize.LARGE_10KG) + " Large 10kg plates for " +
	...
	public void run() {
		...
		noOfWeightPlates.put(WeightPlateSize.SMALL_3KG, new Integer(NUM_SMALL));
		noOfWeightPlates.put(WeightPlateSize.MEDIUM_5KG, new Integer(NUM_MED));
		noOfWeightPlates.put(WeightPlateSize.LARGE_10KG, new Integer(NUM_LARGE));
